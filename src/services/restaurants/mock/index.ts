...
import { RestaurantsResponse } from "../restaurants.interfaces";

export const mocks: Record<string, RestaurantsResponse> = {
  "51.219448,4.402464": (antwerp as unknown) as RestaurantsResponse,
  "43.653225,-79.383186": (toronto as unknown) as RestaurantsResponse,
  "41.878113,-87.629799": (chicago as unknown) as RestaurantsResponse,
  "37.7749295,-122.4194155": (san_francisco as unknown) as RestaurantsResponse,
};
